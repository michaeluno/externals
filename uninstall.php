 ...
 */
$_sMaingPluginFileName  = 'externals.php';
...
// 1. Delete transients
$_aPrefixes = array(
    Externals_Registry::TRANSIENT_PREFIX, // the plugin transients
...
// 2. Delete options
$_aOptions = get_option( Externals_Registry::$aOptionKeys[ 'setting' ], array() );
...
array_walk_recursive( 
    Externals_Registry::$aOptionKeys, // subject array
