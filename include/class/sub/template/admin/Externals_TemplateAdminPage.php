 ...
 * @since        1
 */
class Externals_TemplateAdminPage extends Externals_AdminPageFramework {
    ...
    public function setUp() {
        ...
        // Add pages      
        new Externals_TemplateAdminPage_Template( 
            $this,
            array(
                'page_slug' => Externals_Registry::$aAdminPages[ 'template' ],
                'title'     => __( 'Templates', 'externals' ),
                'style'     => Externals_Registry::getPluginURL( 'asset/css/externals_templates.css' ),
                'order'     => 70,
            )                
        );
