...
/**
 * Handles the list table of Externals templates. 
 * @filter      externals_filter_template_listing_table_action_links
 * @since        1
 */
class Externals_ListTable_Template extends WP_List_Table {
    ...
    public function column_thumbnail( $aItem ) {
        ...
        $_sImageURL = esc_url(
            Externals_WPUtility::getSRCFromPath( $aItem[ 'thumbnail_path' ] )
        );
    ...
    public function column_description( $aItem ) {
        ...
        $aActions = array(
            ...
            'css'       => sprintf( 
                ...
                Externals_WPUtility::getSRCFromPath( ABSPATH . $aItem[ 'relative_dir_path' ] . DIRECTORY_SEPARATOR . 'style.css' )
            ),
        );
        return sprintf(
            ...
            wp_redirect( 
                add_query_arg( 
                    array(
                        ...
                        'page'      => Externals_Registry::$aAdminPages[ 'template' ],
                        'tab'       => 'table',
                    ), 
