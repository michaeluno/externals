 ...
 * @deprecated
 */ 
class _Externals_SimplePie extends Externals_SimplePie_Base {
    ...
    public function __construct() {
        ...
        $this->useragent  = Externals_Registry::NAME;
        $this->sPluginKey = Externals_Registry::TRANSIENT_PREFIX . '_FeedMs';
        ...
        $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ] = isset( $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ] ) && is_array( $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ] ) 
            ...
            : ( array ) Externals_WPUtility::getTransient( $this->sPluginKey );
        ...
        public function replyToUpdateCacheItems() {    
            ...
            if ( ! ( isset( $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ]['bIsCacheTransientSet'] ) && $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ]['bIsCacheTransientSet'] ) ) {
                ...
                Externals_WPUtility::setTransient( 
                    $this->sPluginKey, 
                    $GLOBALS['aSimplePieCacheModTimestamps'][ $this->sPluginKey ], 
            ...
            protected function _scheduleCacheRenewal( $aURLs ) {
                ...
                if ( wp_next_scheduled( 'externals_action_simplepie_renew_cache', array( $aURLs ) ) ) {
                    return;        
                }
                wp_schedule_single_event( 
                    time(), // now
                    'externals_action_simplepie_renew_cache', // action hook name
    ...
    function set_force_cache_class( $sClassName='Externals_SimplePie_Cache' ) {
        $this->cache_class = $sClassName;
    }
    function set_force_file_class( $sClassName='Externals_SimplePie_File' ) {
...
class Externals_SimplePie_Cache_Transient {
    ...
    public function load() {       
        ...
        return Externals_WPUtility::getTransient( 
            $this->sTransientName 
        );
...
// return 0;    
    ...
    public function unlink() {
        ...
        Externals_WPUtility::deleteTransient( 
            $this->sTransientName 
        );
        return true;
    }
