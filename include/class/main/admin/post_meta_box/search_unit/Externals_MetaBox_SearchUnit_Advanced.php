 ...
 */
class Externals_MetaBox_SearchExternal_Advanced extends Externals_PostMetaBox_Base {
    
    /**
     * Stores the unit type slug(s). 
     */    
    protected $aExternalTypes = array( 'search' );
    ...
    public function setUp() {
        ...
        $_oFields = new Externals_FormFields_SearchExternal_ProductSearchAdvanced;
