 ...
 */
class Externals_MetaBox_TagExternal_Main extends Externals_PostMetaBox_Base {
    
    /**
     * Stores the unit type slug(s). 
     */    
    protected $aExternalTypes = array( 'tag' );
    ...
    public function setUp() {
        ...
        $_oFields = new Externals_FormFields_TagExternal_Main;
