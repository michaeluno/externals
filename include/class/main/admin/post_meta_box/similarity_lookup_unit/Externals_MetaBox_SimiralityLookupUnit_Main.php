 ...
 */
class Externals_MetaBox_SimilarityLookupExternal_Main extends Externals_PostMetaBox_Base {
    ...
    public function setUp() {
        ...
        $_oFields = new Externals_FormFields_SimilarityLookupExternal_Main;
