...
class Externals_Shadow {
    ...
    protected function _handleCronTasks( $aActionHooks ) {
        ...
        $_aTasks = Externals_WPUtility::getTransient( $_sTransientName );
        ...
        Externals_WPUtility::setTransient( $_sTransientName, $aFlagKeys + $_aTasks, $this->getAllowedMaxExecutionTime() ); // lock the process.
        $this->_doTasks( $_aTasks );    

        // remove tasks but leave the flag element.
        Externals_WPUtility::setTransient( $_sTransientName, $aFlagKeys, $this->getAllowedMaxExecutionTime() ); // lock the process.
        exit;
