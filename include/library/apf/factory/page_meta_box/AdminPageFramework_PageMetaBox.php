...
abstract class Externals_AdminPageFramework_PageMetaBox_Router extends Externals_AdminPageFramework_MetaBox_View {
...
abstract class Externals_AdminPageFramework_PageMetaBox_Model extends Externals_AdminPageFramework_PageMetaBox_Router {
    static protected $_sStructureType = 'page_meta_box';
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'externals') {
        $this->oProp = new Externals_AdminPageFramework_Property_page_meta_box($this, get_class($this), $sCapability, $sTextDomain, self::$_sStructureType);
...
abstract class Externals_AdminPageFramework_PageMetaBox_View extends Externals_AdminPageFramework_PageMetaBox_Model {
}
abstract class Externals_AdminPageFramework_PageMetaBox_Controller extends Externals_AdminPageFramework_PageMetaBox_View {
...
abstract class Externals_AdminPageFramework_PageMetaBox extends Externals_AdminPageFramework_PageMetaBox_Controller {
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'externals') {
