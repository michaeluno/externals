...
abstract class Externals_AdminPageFramework_PostType_Router extends Externals_AdminPageFramework_Factory {
    ...
    protected function _getLinkObject() {
        return new Externals_AdminPageFramework_Link_post_type($this->oProp, $this->oMsg);
    }
    protected function _getPageLoadObject() {
        return new Externals_AdminPageFramework_PageLoadInfo_post_type($this->oProp, $this->oMsg);
    }
...
abstract class Externals_AdminPageFramework_PostType_Model extends Externals_AdminPageFramework_PostType_Router {
    function __construct($oProp) {
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            new Externals_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new Externals_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class Externals_AdminPageFramework_PostType_View extends Externals_AdminPageFramework_PostType_Model {
    function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='externals-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class Externals_AdminPageFramework_PostType_Controller extends Externals_AdminPageFramework_PostType_View {
...
abstract class Externals_AdminPageFramework_PostType extends Externals_AdminPageFramework_PostType_Controller {
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'externals') {
        if (empty($sPostType)) {
            return;
        }
        $this->oProp = new Externals_AdminPageFramework_Property_post_type($this, $this->_getCallerScriptPath($sCallerPath), get_class($this), 'publish_posts', $sTextDomain, 'post_type');
        $this->oProp->sPostType = Externals_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = Externals_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php',))) {
            return Externals_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}