...
class Externals_AdminPageFramework_AdminNotice extends Externals_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'externals-settings-notice-message', 'externals-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new Externals_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
