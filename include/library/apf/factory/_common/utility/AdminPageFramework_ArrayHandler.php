...
class Externals_AdminPageFramework_FrameworkUtility extends Externals_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = Externals_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return Externals_AdminPageFramework_Registry::NAME;
    }
}
class Externals_AdminPageFramework_ArrayHandler extends Externals_AdminPageFramework_FrameworkUtility {
    public $aData = array();
