...
class Externals_AdminPageFramework_WPUtility_URL extends Externals_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(Externals_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(Externals_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $_sRelativePath = Externals_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
...
class Externals_AdminPageFramework_WPUtility_HTML extends Externals_AdminPageFramework_WPUtility_URL {
...
class Externals_AdminPageFramework_WPUtility_Page extends Externals_AdminPageFramework_WPUtility_HTML {
...
class Externals_AdminPageFramework_WPUtility_Hook extends Externals_AdminPageFramework_WPUtility_Page {
...
class Externals_AdminPageFramework_WPUtility_File extends Externals_AdminPageFramework_WPUtility_Hook {
...
class Externals_AdminPageFramework_WPUtility_Option extends Externals_AdminPageFramework_WPUtility_File {
...
class Externals_AdminPageFramework_WPUtility_Meta extends Externals_AdminPageFramework_WPUtility_Option {
...
class Externals_AdminPageFramework_WPUtility_SiteInformation extends Externals_AdminPageFramework_WPUtility_Meta {
...
class Externals_AdminPageFramework_WPUtility_SystemInformation extends Externals_AdminPageFramework_WPUtility_SiteInformation {
...
class Externals_AdminPageFramework_WPUtility extends Externals_AdminPageFramework_WPUtility_SystemInformation {
