...
class Externals_AdminPageFramework_FieldType_radio extends Externals_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return <<<CSSRULES
/* Radio Field Type */
.externals-field input[type='radio'] {
    margin-right: 0.5em;
}     
.externals-field-radio .externals-input-label-container {
    padding-right: 1em;
}     
.externals-field-radio .externals-input-container {
    display: inline;
}     
.externals-field-radio .externals-input-label-string  {
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.externals-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
