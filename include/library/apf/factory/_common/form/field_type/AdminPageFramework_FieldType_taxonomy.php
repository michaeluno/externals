...
class Externals_AdminPageFramework_FieldType_taxonomy extends Externals_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new Externals_AdminPageFramework_Form_View___Script_CheckboxSelector;
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        return parent::getScripts() . <<<JAVASCRIPTS
/* For tabs */
var enableExternals_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableExternals_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerExternals_AdminPageFrameworkCallbacks( {     
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            enableExternals_AdminPageFrameworkTabbedBox( jQuery( oCloned ).find( '.tab-box-container' ) );            
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Taxonomy Field Type */
.externals-field .taxonomy-checklist li { 
    margin: 8px 0 8px 20px; 
}
.externals-field div.taxonomy-checklist {
    padding: 8px 0 8px 10px;
    margin-bottom: 20px;
}
.externals-field .taxonomy-checklist ul {
    list-style-type: none;
    margin: 0;
}
.externals-field .taxonomy-checklist ul ul {
    margin-left: 1em;
}
.externals-field .taxonomy-checklist-label {
    /* margin-left: 0.5em; */
    white-space: nowrap;     
}    
/* Tabbed box */
.externals-field .tab-box-container.categorydiv {
    max-height: none;
}
.externals-field .tab-box-tab-text {
    display: inline-block;
}
.externals-field .tab-box-tabs {
    line-height: 12px;
    margin-bottom: 0;
}
/* .externals-field .tab-box-tab {     
    vertical-align: top;
} */
.externals-field .tab-box-tabs .tab-box-tab.active {
    display: inline;
...
.externals-field .tab-box-container { 
    position: relative; 
    width: 100%; 
    clear: both;
    margin-bottom: 1em;
}
.externals-field .tab-box-tabs li a { color: #333; text-decoration: none; }
.externals-field .tab-box-contents-container {  
    padding: 0 0 0 1.8em;
    padding: 0.55em 0.5em 0.55em 1.8em;
    border: 1px solid #dfdfdf; 
    background-color: #fff;
}
.externals-field .tab-box-contents { 
    overflow: hidden; 
    overflow-x: hidden; 
    position: relative; 
    top: -1px; 
...
.externals-field .tab-box-content { 
...
.externals-field .tab-box-content .taxonomychecklist {
    margin-right: 3.2em;
}
.externals-field .tab-box-content:target, 
.externals-field .tab-box-content:target, 
.externals-field .tab-box-content:target { 
    display: block; 
}  
/* tab-box-content */
.externals-field .tab-box-content .select_all_button_container, 
.externals-field .tab-box-content .select_none_button_container
{
    margin-top: 0.8em;
}
/* Nested Checkbox Items */
.externals-field .taxonomychecklist .children {
    margin-top: 6px;
    margin-left: 1em;
}
CSSRULES;
