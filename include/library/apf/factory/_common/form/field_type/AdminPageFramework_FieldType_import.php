...
class Externals_AdminPageFramework_FieldType_import extends Externals_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Import Field */
.externals-field-import input {
    margin-right: 0.5em;
}
.externals-field-import label,
.form-table td fieldset.externals-fieldset .externals-field-import label { /* for Wordpress 3.8 or above */
