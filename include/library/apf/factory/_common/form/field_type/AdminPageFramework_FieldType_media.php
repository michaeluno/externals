...
class Externals_AdminPageFramework_FieldType_image extends Externals_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerExternals_AdminPageFrameworkCallbacks( {   
        /**
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType, iSectionIndex, iFieldIndex ) {
            ...
            switch( iCallType ) {
                ...
                case 1: 
                    ...
                    var _oSectionsContainer     = jQuery( oCloned ).closest( '.externals-sections' );
                ...
                case 0:
                    ...
                    var _oFieldsContainer   = jQuery( oCloned ).closest( '.externals-fields' );
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.externals-field' );
            ...
            setExternals_AdminPageFrameworkImageUploader( 
 ...
 */
setExternals_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfExternals_AdminPageFrameworkSendToEditorImage;
...
var hfExternals_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setExternals_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oExternals_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getExternals_AdminPageFrameworkCustomMediaUploaderSelectObject() : oExternals_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.externals-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addExternals_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oExternals_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.externals-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
.externals-field .image_preview img {     
    display: block;  
    height: auto; 
    max-width: 100%;
}
.widget .externals-field .image_preview {
    max-width: 100%;
}            
...
jQuery( document ).ready( function(){     
    setExternals_AdminPageFrameworkImageUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='externals-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='externals-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
class Externals_AdminPageFramework_FieldType_media extends Externals_AdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerExternals_AdminPageFrameworkCallbacks( {    
        ...
        added_repeatable_field: function( oCloned, sFieldType, sFieldTagID, iCallType ) {
            ...
            setExternals_AdminPageFrameworkMediaUploader( 
    ...
    private function _getScript_MediaUploader($sReferrer) {
        ...
        if (!function_exists('wp_enqueue_media')) {
            return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setExternals_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfExternals_AdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfExternals_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
        ...
        return <<<JAVASCRIPTS
                ...
                setExternals_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oExternals_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getExternals_AdminPageFrameworkCustomMediaUploaderSelectObject() : oExternals_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oExternals_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.externals-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
jQuery( document ).ready( function(){     
    setExternals_AdminPageFrameworkMediaUploader( '{$sInputID}', '{$bRpeatable}', '{$bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='externals-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
