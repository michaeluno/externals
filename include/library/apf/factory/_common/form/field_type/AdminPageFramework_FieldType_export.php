...
class Externals_AdminPageFramework_FieldType_submit extends Externals_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return <<<CSSRULES
/* Submit Buttons */
.externals-field input[type='submit'] {
    margin-bottom: 0.5em;
}
CSSRULES;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] ? "min-width:" . $this->sanitizeLength($aField['label_min_width']) . ";" : null, 'class' => 'externals-input-label-container' . ' externals-input-button-container' . ' externals-input-container',);
    }
...
class Externals_AdminPageFramework_FieldType_export extends Externals_AdminPageFramework_FieldType_submit {
