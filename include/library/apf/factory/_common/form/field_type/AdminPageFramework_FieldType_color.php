...
abstract class Externals_AdminPageFramework_FieldType_Base extends Externals_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : Externals_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function geFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new Externals_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new Externals_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class Externals_AdminPageFramework_FieldType extends Externals_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class Externals_AdminPageFramework_FieldType_color extends Externals_AdminPageFramework_FieldType {
...
.externals-field-color .wp-picker-container {
    vertical-align: middle;
}
.externals-field-color .ui-widget-content {
    border: none;
    background: none;
    color: transparent;
}
.externals-field-color .ui-slider-vertical {
    width: inherit;
    height: auto;
    margin-top: -11px;
}
.externals-field-color .externals-repeatable-field-buttons {
    margin-top: 0;
}
.externals-field-color .wp-color-result {
...
CSSRULES;
    ...
    protected function getScripts() {
        ...
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerExternals_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerExternals_AdminPageFrameworkCallbacks( {     
        added_repeatable_field: function( node, sFieldType, sFieldTagID, sCallType ) {
            ...
            registerExternals_AdminPageFrameworkColorPickerField( nodeNewColorInput );     
...
jQuery( document ).ready( function(){
    registerExternals_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
