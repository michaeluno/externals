...
abstract class Externals_AdminPageFramework_Input_Base extends Externals_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'externals-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'externals-input-label-string',),);
...
class Externals_AdminPageFramework_Input_checkbox extends Externals_AdminPageFramework_Input_Base {
    public function get() {
