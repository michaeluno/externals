...
class Externals_AdminPageFramework_Form_View___FieldsetTableRow extends Externals_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new Externals_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'externals-fieldrow',));
        return $this->_getFieldByContainer($aFieldset, array('open_container' => "<tr " . $_oFieldrowAttribute->get() . ">", 'close_container' => "</tr>", 'open_title' => "<th>", 'close_title' => "</th>", 'open_main' => "<td " . $this->getAttributes(array('colspan' => $aFieldset['show_title_column'] ? 1 : 2, 'class' => $aFieldset['show_title_column'] ? null : 'externals-field-td-no-title',)) . ">", 'close_main' => "</td>",));
    }
    ...
    private function _getFieldTitle(array $aField) {
        $_oInputTagIDGenerator = new Externals_AdminPageFramework_Form_View___Generate_FieldInputID($aField, 0);
    ...
    private function _getToolTip($asTip, $sElementID) {
        $_oToolTip = new Externals_AdminPageFramework_Form_View___ToolTip($asTip, $sElementID);
...
class Externals_AdminPageFramework_Form_View___FieldsetRow extends Externals_AdminPageFramework_Form_View___FieldsetTableRow {
    public $aFieldset = array();
    public $aSavedData = array();
    public $aFieldErrors = array();
    public $aFieldTypeDefinitions = array();
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new Externals_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
