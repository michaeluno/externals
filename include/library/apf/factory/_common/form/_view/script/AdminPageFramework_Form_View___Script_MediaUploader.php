...
class Externals_AdminPageFramework_Form_View___Script_MediaUploader extends Externals_AdminPageFramework_Form_View___Script_Base {
...
(function ( $ ) {
    ...
    getExternals_AdminPageFrameworkCustomMediaUploaderSelectObject = function() {
