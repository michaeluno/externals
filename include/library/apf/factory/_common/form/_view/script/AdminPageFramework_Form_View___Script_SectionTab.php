...
class Externals_AdminPageFramework_Form_View___Script_SectionTab extends Externals_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.externals-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='externals-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}