...
class Externals_AdminPageFramework_Form_View___Generate_FieldTagID extends Externals_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class Externals_AdminPageFramework_Form_View___Generate_FieldInputID extends Externals_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
