...
class Externals_AdminPageFramework_Form_View__Resource__Head extends Externals_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    public function _replyToInsertRequiredInlineScripts() {
        ...
        echo "<script type='text/javascript' class='externals-form-script-required-in-head'>" . '/* <![CDATA[ */ ' . $this->_getScripts_RequiredInHead() . ' /* ]]> */' . "</script>";
    }
    private function _getScripts_RequiredInHead() {
        return 'document.write( "<style class=\'externals-js-embedded-inline-style\'>' . str_replace('\\n', '', esc_js($this->_getInlineCSS())) . '</style>" );';
    }
    private function _getInlineCSS() {
        $_oLoadingCSS = new Externals_AdminPageFramework_Form_View___CSS_Loading;
    ...
    private function _getScriptElementConcealerCSSRules() {
        return <<<CSSRULES
.externals-form-js-on {  
    visibility: hidden;
}
.widget .externals-form-js-on { 
    visibility: visible; 
}
CSSRULES;
