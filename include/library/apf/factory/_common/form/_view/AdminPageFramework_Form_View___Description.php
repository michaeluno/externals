...
class Externals_AdminPageFramework_Form_View___Description extends Externals_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'externals-form-element-description';
