...
abstract class Externals_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected function _getFormObject($oProp) {
        ...
        $_sFormClass = "Externals_AdminPageFramework_Form_{$oProp->_sPropertyType}";
    ...
    public function _replyTpSetAndGetInstance_oUtil() {
        $this->oUtil = new Externals_AdminPageFramework_FrameworkUtility;
        return $this->oUtil;
    }
    public function _replyTpSetAndGetInstance_oDebug() {
        $this->oDebug = new Externals_AdminPageFramework_Debug;
        return $this->oDebug;
    }
    public function _replyTpSetAndGetInstance_oMsg() {
        $this->oMsg = Externals_AdminPageFramework_Message::getInstance($this->oProp->sTextDomain);
        return $this->oMsg;
    }
    ...
    public function _replyTpSetAndGetInstance_oResource() {
        ...
        $_sClassName = "Externals_AdminPageFramework_Resource_{$this->oProp->_sPropertyType}";
    ...
    public function _replyTpSetAndGetInstance_oHelpPane() {
        $_sClassName = "Externals_AdminPageFramework_HelpPane_{$this->oProp->_sPropertyType}";
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(Externals_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
...
abstract class Externals_AdminPageFramework_Factory_Model extends Externals_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class Externals_AdminPageFramework_Factory_View extends Externals_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new Externals_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class Externals_AdminPageFramework_Factory_Controller extends Externals_AdminPageFramework_Factory_View {
...
abstract class Externals_AdminPageFramework_Factory extends Externals_AdminPageFramework_Factory_Controller {
}