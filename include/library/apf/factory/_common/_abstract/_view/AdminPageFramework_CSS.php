...
class Externals_AdminPageFramework_CSS {
    static public function getDefaultCSS() {
        $_sCSS = <<<CSSRULES
/* Settings Notice */
.wrap div.updated.externals-settings-notice-container, 
.wrap div.error.externals-settings-notice-container, 
.media-upload-form div.error.externals-settings-notice-container
{
    clear: both;
    margin-top: 16px;
}
.wrap div.error.confirmation.externals-settings-notice-container {
    border-color: #368ADD;
}  
...
.externals-container #poststuff .externals-content h3 {
    font-weight: bold;
    font-size: 1.3em;
    margin: 1em 0;
    padding: 0;
...
/* In-page tabs */ 
.externals-in-page-tab .nav-tab.nav-tab-active {
    border-bottom-width: 2px;
}
/* Give a space between generic admin notice containers and the in-page navigation tabs */
.wrap .externals-in-page-tab div.error, 
.wrap .externals-in-page-tab div.updated {
    margin-top: 15px;
}
...
CSSRULES;
    ...
    static private function _getPageLoadStatsRules() {
        return <<<CSSRULES
/* Page Load Stats */
#externals-page-load-stats {
    clear: both;
    display: inline-block;
    width: 100%
}
#externals-page-load-stats li{
    display: inline;
    margin-right: 1em;
}     
