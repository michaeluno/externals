...
abstract class Externals_AdminPageFramework_Property_Base extends Externals_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'externals' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aExternals_AdminPageFramework'])) {
            $GLOBALS['aExternals_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Externals_AdminPageFramework_Registry::NAME, 'sURI' => Externals_AdminPageFramework_Registry::URI, 'sScriptName' => Externals_AdminPageFramework_Registry::NAME, 'sLibraryName' => Externals_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Externals_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Externals_AdminPageFramework_Registry::getVersion(), 'sDescription' => Externals_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Externals_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Externals_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Externals_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Externals_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new Externals_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}