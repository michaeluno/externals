...
class Externals_AdminPageFramework_Model__FormSubmission__Validator_Base extends Externals_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class Externals_AdminPageFramework_Model__FormSubmission__Validator extends Externals_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('Externals_AdminPageFramework_Model__FormSubmission__Validator__Link', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__Import', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__Export', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'Externals_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new Externals_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
