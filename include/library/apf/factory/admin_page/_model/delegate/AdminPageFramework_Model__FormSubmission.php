...
abstract class Externals_AdminPageFramework_Model__FormSubmission_Base extends Externals_AdminPageFramework_FrameworkUtility {
...
class Externals_AdminPageFramework_Model__FormSubmission extends Externals_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new Externals_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new Externals_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
