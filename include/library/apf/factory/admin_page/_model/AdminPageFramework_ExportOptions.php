...
abstract class Externals_AdminPageFramework_CustomSubmitFields extends Externals_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class Externals_AdminPageFramework_ExportOptions extends Externals_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo Externals_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
