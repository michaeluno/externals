...
class Externals_AdminPageFramework_Property_admin_page extends Externals_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        ...
        $GLOBALS['aExternals_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aExternals_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aExternals_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
