...
abstract class Externals_AdminPageFramework_Router extends Externals_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        $this->oProp = isset($this->oProp) ? $this->oProp : new Externals_AdminPageFramework_Property_admin_page($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
    ...
    protected function _getLinkObject() {
        return new Externals_AdminPageFramework_Link_admin_page($this->oProp, $this->oMsg);
    }
    protected function _getPageLoadObject() {
        return new Externals_AdminPageFramework_PageLoadInfo_admin_page($this->oProp, $this->oMsg);
    }
...
abstract class Externals_AdminPageFramework_Model_Form extends Externals_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        ...
        new Externals_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new Externals_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class Externals_AdminPageFramework_View_Form extends Externals_AdminPageFramework_Model_Form {
...
abstract class Externals_AdminPageFramework_Controller_Form extends Externals_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return Externals_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class Externals_AdminPageFramework_Model_Page extends Externals_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new Externals_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class Externals_AdminPageFramework_View_Page extends Externals_AdminPageFramework_Model_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new Externals_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new Externals_AdminPageFramework_View__Resource($this);
    }
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new Externals_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class Externals_AdminPageFramework_Controller_Page extends Externals_AdminPageFramework_View_Page {
...
abstract class Externals_AdminPageFramework_Model_Menu extends Externals_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        if ($this->oProp->bIsAdminAjax) {
            return;
        }
        new Externals_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class Externals_AdminPageFramework_View_Menu extends Externals_AdminPageFramework_Model_Menu {
}
abstract class Externals_AdminPageFramework_Controller_Menu extends Externals_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new Externals_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new Externals_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class Externals_AdminPageFramework_Model extends Externals_AdminPageFramework_Controller_Menu {
}
abstract class Externals_AdminPageFramework_View extends Externals_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class Externals_AdminPageFramework_Controller extends Externals_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new Externals_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, '_isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return Externals_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class Externals_AdminPageFramework extends Externals_AdminPageFramework_Controller {
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'externals') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        parent::__construct($isOptionKey, $sCallerPath ? trim($sCallerPath) : $sCallerPath = (is_admin() && (isset($GLOBALS['pagenow']) && in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page'])) ? Externals_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null), $sCapability, $sTextDomain);
    }
}