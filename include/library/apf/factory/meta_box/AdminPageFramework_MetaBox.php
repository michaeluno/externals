...
abstract class Externals_AdminPageFramework_MetaBox_Router extends Externals_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'externals') {
...
abstract class Externals_AdminPageFramework_MetaBox_Model extends Externals_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'externals') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new Externals_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class Externals_AdminPageFramework_MetaBox_View extends Externals_AdminPageFramework_MetaBox_Model {
...
abstract class Externals_AdminPageFramework_MetaBox_Controller extends Externals_AdminPageFramework_MetaBox_View {
...
abstract class Externals_AdminPageFramework_MetaBox extends Externals_AdminPageFramework_MetaBox_Controller {
    ...
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'externals') {
        ...
        $this->oProp = new Externals_AdminPageFramework_Property_post_meta_box($this, get_class($this), $sCapability, $sTextDomain, self::$_sStructureType);
