...
class Externals_AdminPageFramework_Property_post_meta_box extends Externals_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'externals', $sStructureType = 'post_meta_box') {
