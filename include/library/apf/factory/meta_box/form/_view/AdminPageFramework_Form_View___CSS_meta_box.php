...
class Externals_AdminPageFramework_Form_View___CSS_meta_box extends Externals_AdminPageFramework_Form_View___CSS_Base {
...
.postbox .externals-section .form-table > tbody > tr > td,
.postbox .externals-section .form-table > tbody > tr > th
{
...
.postbox .sortable .externals-field {
...
#poststuff .metabox-holder .postbox-container .externals-section-title h3 {
    border: none;
    font-weight: bold;
    font-size: 1.12em;
    margin: 1em 0;
...
#poststuff .metabox-holder .postbox-container .externals-collapsible-title h3 {
    margin: 0;
}
...
#poststuff .metabox-holder .postbox-container .externals-section-tab h4 {
    margin: 0;
}
...
@media screen and (min-width: 783px) {    
    ...
    #poststuff #post-body.columns-2 #side-sortables .postbox .externals-section .form-table input[type=text]{
        width: 98%;
    }
}            
CSSRULES;
