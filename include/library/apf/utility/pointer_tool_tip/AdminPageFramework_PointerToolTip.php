...
class Externals_AdminPageFramework_PointerToolTip extends Externals_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInlineScript() {
        echo "<script type='text/javascript' class='externals-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInlineScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
