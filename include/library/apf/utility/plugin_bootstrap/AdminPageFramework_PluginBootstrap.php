...
abstract class Externals_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('Externals_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new Externals_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
